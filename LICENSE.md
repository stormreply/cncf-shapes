All files in this repo, excluding the images within the folder "img", is made available under the Linux Foundation trademark
...
The images within the folder img are made public under the Apache License 2.0.
